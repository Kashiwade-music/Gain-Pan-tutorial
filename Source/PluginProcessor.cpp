...
#endif
    , parameters(*this, nullptr, juce::Identifier("tutorial"), // ’Ç‰Á
        {// ’Ç‰Á
            ...
            std::make_unique<juce::AudioParameterFloat>(
                "panangle",  // ’Ç‰Á
                "Pan Angle",  // ’Ç‰Á
                juce::NormalisableRange<float>(-100.0f, 100.0f),// ’Ç‰Á
                0.0f),// ’Ç‰Á
        })// ’Ç‰Á
{
}
...
GainPantutorialAudioProcessor::~GainPantutorialAudioProcessor()
{
    gain = parameters.getRawParameterValue("gain"); // ’Ç‰Á
    panAngle = parameters.getRawParameterValue("panangle"); // ’Ç‰Á
    panRule = parameters.getRawParameterValue("panrule"); // ’Ç‰Á
}
